...
> Comparando-se os seis modelos verificou-se que o modelo com menor valor AIC é o modelo 6, e portanto é o preferível. 
...
O teste ANOVA indica que a diferença entre os dois modelos não é estatisticamente significativa (p = 0.358), sugerindo que o modelo mais simples (modelo6), sem essas variáveis adicionais, é preferível por ser mais mais simples e com a mesma capacidade de ajuste.
...
Pode-se observar no primeiro gráfico Residuals vc Fitted, que o modelo apresenta uma boa linearidade, já que a linha vermelha indica uma relação linear quando está próxima da linha cinza.

No gráfico Q-Q Residuals pode-se notar que os erros tem uma distribuição aproximadamente normal já que os pontos estão próximos a linha pontilhada.

No gráfico do Scale-Location é possível observar que a variância dos resíduos que é constante ao longo dos valores ajustados, o que indica que a suposição de homocedasticidade foi atendida.
...
Fizemos o ajuste de um modelo linear (estimado usando OLS) para prever Vendas com CompPrice, Renda, Publicidade, Preço, Localização da Prateleira e Idade (fórmula: Vendas ~ CompPrice + Renda + Publicidade + Preço + Localização da Prateleira + Idade). O modelo explica uma proporção estatisticamente significativa e substancial de variância (R² = 0,87, F(7, 392) = 381,44, p < 0,001, R² ajustado = 0,87). O intercepto do modelo, correspondente a CompPrice = 0, Renda = 0, Publicidade = 0, Preço = 0, Localização da Prateleira = Ruim e Idade = 0, é de 5,48 (IC 95% [4,48, 6,47], t(392) = 10,84, p < 0,001). Dentro deste modelo:

<!-- -->
- O efeito de CompPrice é estatisticamente significativo e positivo (beta = 0,09, IC 95% [0,08, 0,10], t(392) = 22,45, p < 0,001; beta padrão = 0,50, IC 95% [0,46, 0,55])
- O efeito de Renda é estatisticamente significativo e positivo (beta = 0,02, IC 95% [0,01, 0,02], t(392) = 8,59, p < 0,001; beta padrão = 0,16, IC 95% [0,12, 0,19])
- O efeito de Publicidade é estatisticamente significativo e positivo (beta = 0,12, IC 95% [0,10, 0,13], t(392) = 15,01, p < 0,001; beta padrão = 0,27, IC 95% [0,24, 0,31])
- O efeito de Preço é estatisticamente significativo e negativo (beta = -0,10, IC 95% [-0,10, -0,09], t(392) = -35,70, p < 0,001; beta padrão = -0,80, IC 95% [-0,84, -0,76])
- O efeito de Localização da Prateleira [Boa] é estatisticamente significativo e positivo (beta = 4,84, IC 95% [4,54, 5,14], t(392) = 31,71, p < 0,001; beta padrão = 1,71, IC 95% [1,61, 1,82])
- O efeito de Localização da Prateleira [Média] é estatisticamente significativo e positivo (beta = 1,95, IC 95% [1,71, 2,20], t(392) = 15,57, p < 0,001; beta padrão = 0,69, IC 95% [0,60, 0,78])
- O efeito de Idade é estatisticamente significativo e negativo (beta = -0,05, IC 95% [-0,05, -0,04], t(392) = -14,52, p < 0,001; beta padrão = -0,26, IC 95% [-0,30, -0,23])
